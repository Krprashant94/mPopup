(function($) {
	p = $.fn.mPopup = function(e) {
		...
		$('body').append('<div id="mPopup"> <div class="content"> <span class="img" onClick="mPopup_close();"></span> <div class="head"></div> <div class="body"></div><br/><div class="foot"></div> </div> </div>');
		$('#mPopup').hide();
